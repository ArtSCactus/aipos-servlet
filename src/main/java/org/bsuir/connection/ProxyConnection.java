...
import org.bsuir.exceptions.connection.ConnectionClosingException;
...
public class ProxyConnection implements Connection, AutoCloseable {
     ...
     *                      or this method is called on a closed org.bsuir.connection
     */
    @Override
    ...
    /**
     * Sets this org.bsuir.connection's auto-commit mode to the given state.
     * If a org.bsuir.connection is in auto-commit mode, then all its SQL
     ...
     *                      if this method is called on a closed org.bsuir.connection or this
     ...
     * @throws SQLException if a database access error occurs,
     *                      this method is called while participating in a distributed transaction,
     *                      this method is called on a closed org.bsuir.connection or this
     *                      <code>Connection</code> object is in auto-commit mode
     * @see #setAutoCommit
     */
    @Override
    ...
    /**
     * Turns on autocommit and then asking org.bsuir.connection pool to release this org.bsuir.connection.
     *
     ...
     * closed.  A org.bsuir.connection is closed if the method <code>close</code>
     ...
     * org.bsuir.connection to a database is valid or invalid.  A typical client
     * can determine that a org.bsuir.connection is invalid by catching any
     * org.bsuir.exceptions that might be thrown when an operation is attempted.
     *
     ...
     * <code>Connection</code> object represents a org.bsuir.connection.
     * The metadata includes information about the database's
     * tables, its supported SQL grammar, its stored
     * procedures, the capabilities of this org.bsuir.connection, and so on.
     *
     ...
     * @throws SQLException                    if a database access error occurs,
     *                                         this method is called while participating in a distributed transaction,
     *                                         this method is called on a closed org.bsuir.connection,
    ...
    /**
     * Puts this org.bsuir.connection in read-only mode as a hint to the driver to enable
     ...
     *                      method is called on a closed org.bsuir.connection or this
     ...
     * @throws SQLException if a database access error occurs, this
     *                      method is called on a closed org.bsuir.connection
     ...
     * called on a closed org.bsuir.connection; doing so will cause an
     ...
     *                                         is called on a closed org.bsuir.connection
     *                                         or the given parameters are not <code>ResultSet</code>
     *                                         constants indicating type and concurrency
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method or this method is not supported for the specified result
     ...
     * @throws SQLException                    if a database access error occurs, this
     *                                         method is called on a closed org.bsuir.connection or
     ...
     *                                         on a closed org.bsuir.connection, or the given parameter
     ...
     *                                         called on a closed org.bsuir.connection or a database access error occurs.
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this data type
     * @since 1.6
     */
    ...
    /**
     * Returns true if the org.bsuir.connection has not been closed and is still valid.
     * The driver shall submit a query on the org.bsuir.connection or use some other
     * mechanism that positively verifies the org.bsuir.connection is still valid when
     * this method is called.
     * <p>
     * The query submitted by the driver to validate the org.bsuir.connection shall be
     * executed in the context of the current transaction.
     *
     * @param timeout -             The time in seconds to wait for the database operation
     *                used to validate the org.bsuir.connection to complete.  If
     *                the timeout period expires before the operation
     *                completes, this method returns false.  A value of
     *                0 indicates a timeout is not applied to the
     *                database operation.
     *                <p>
     * @return true if the org.bsuir.connection is valid, false otherwise
     ...
     * database.  For bsuir in a special register, session parameter, or
     * system table column.  For efficiency the driver may defer setting the
     * value in the database until the next time a statement is executed or
     * prepared.  Other than storing the client information in the appropriate
     * place in the database, these methods shall not alter the behavior of
     * the org.bsuir.connection in anyway.  The values supplied to these methods are
     ...
     *                                                      the org.bsuir.connection</li>
     * <li>ClientUser               -       The name of the user that the application using
     *                                                      the org.bsuir.connection is performing work for.  This may
     *                                                      not be the same as the user name that was used
     *                                                      in establishing the org.bsuir.connection.</li>
     * <li>ClientHostname   -       The hostname of the computer the application
     *                                                      using the org.bsuir.connection is running on.</li>
     * </ul>
     * <p>
     *
    ...
    /**
     * Sets the value of the org.bsuir.connection's client info properties.  The
     * <code>Properties</code> object contains the names and values of the client info
     * properties to be set.  The set of client info properties contained in
     * the properties list replaces the current set of client info properties
     * on the org.bsuir.connection.  If a property that is currently set on the
     * org.bsuir.connection is not present in the properties list, that property is
     * cleared.  Specifying an empty properties list will clear all of the
     * properties on the org.bsuir.connection.  See <code>setClientInfo (String, String)</code> for
     * more information.
     * <p>
     ...
     *                                         appropriate for the typeName and the conversion is not supported, the typeName is null or this method is called on a closed org.bsuir.connection
     ...
     * @throws SQLException                    if a database error occurs, the typeName is null or this method is called on a closed org.bsuir.connection
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this data type
     * @since 1.6
     */
    @Override
    ...
    /**
     * Terminates an open org.bsuir.connection.  Calling <code>abort</code> results in:
     * <ul>
     * <li>The org.bsuir.connection marked as closed
     * <li>Closes any physical org.bsuir.connection to the database
     * <li>Releases resources used by the org.bsuir.connection
     * <li>Insures that any thread that is currently accessing the org.bsuir.connection
     * will either progress to completion or throw an <code>SQLException</code>.
     * </ul>
     * <p>
     * Calling <code>abort</code> marks the org.bsuir.connection closed and releases any
     * resources. Calling <code>abort</code> on a closed org.bsuir.connection is a
     * no-op.
     * <p>
     * It is possible that the aborting and releasing of the resources that are
     * held by the org.bsuir.connection can take an extended period of time.  When the
     * <code>abort</code> method returns, the org.bsuir.connection will have been marked as
     ...
     * JDBC org.bsuir.connection is accessible to the administrator thread.
     * The <code>setNetworkTimeout</code> method will cover cases where
     * there is no administrator thread, or it has no access to the
     * org.bsuir.connection. This method is severe in it's effects, and should be
     ...
     * active the result will be that both the statement and org.bsuir.connection
     * are still usable. However if the network timeout expires before
     * the query timeout or if the statement timeout fails due to network
     * problems, the org.bsuir.connection will be marked as closed, any resources held by
     * the org.bsuir.connection will be released and both the org.bsuir.connection and
     * statement will be unusable.
     * <p>
     * When the driver determines that the {@code setNetworkTimeout} timeout
     * value has expired, the JDBC driver marks the org.bsuir.connection
     * closed and releases any resources held by the org.bsuir.connection.
     * <p>
     * <p>
     * This method checks to see that there is an <code>SQLPermission</code>
     * object before allowing the method to proceed.  If a
